...
const airdrops = [
  {
    ...
    description: "Complete on-chain and social tasks across multiple ecosystems.",
  },
  {
    name: "Galxe",
    ...
    url: "https://galxe.com",
    description: "Join crypto campaigns, collect credentials, and participate in reward programs.",
  },
  {
    name: "Zealy",
    ...
    type: "Quest Platform",
    url: "https://zealy.io",
    description: "Projects run engagement tasks here for early community members.",
  },
  {
    name: "Intract",
    ...
    description: "Discover new crypto ecosystems and complete interactive tasks.",
  },
  {
    name: "QuestN",
    ...
    description: "Join promotional quests and Web3 campaign tasks from new projects.",
  },
  {
    ...
    description: "Track public airdrop campaigns from listed crypto projects.",
  },
];
...
export default function AirdropsPage() {
  return (
    <div className="min-h-screen bg-black text-white px-4 md:px-10 py-10">
      <div className="fixed inset-0 -z-10 bg-gradient-to-br from-black via-gray-950 to-purple-950/20" />
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold mb-3">
          🎁{" "}
          <span className="text-purple-400 drop-shadow-[0_0_25px_rgba(168,85,247,0.8)]">
            Crypto Airdrops
          </span>
        </h1>
      ...
      <motion.div
        ...
        className="bg-yellow-500/10 backdrop-blur-sm border border-yellow-500/30 rounded-2xl p-5 mb-10 hover:shadow-[0_0_30px_rgba(234,179,8,0.2)] transition"
      >
        ...
        {airdrops.map((item, idx) => (
          ...
          >
            ...
            <a
              ...
              className="inline-block bg-purple-500 hover:bg-purple-600 text-white font-bold px-5 py-3 rounded-xl transition shadow-[0_0_20px_rgba(168,85,247,0.4)] hover:shadow-[0_0_30px_rgba(168,85,247,0.7)]"
            >
              Visit Platform →
            </a>
          </motion.div>
