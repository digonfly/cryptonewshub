    ...
    <div className="min-h-screen bg-black text-white px-4 md:px-10 py-10">
      ...
      >
        ...
        <p className="text-gray-400">
          Get notified when your favorite coins hit target prices
        </p>
      </motion.div>
      ...
      {alerts.length === 0 ? (
        ...
        >
          ...
          <p className="text-gray-400 mb-6">
            Go to any coin page and click "🔔 Set Alert" to create one
          </p>
          <Link
            href="/coins"
            className="bg-blue-500 hover:bg-blue-600 text-white font-bold px-6 py-3 rounded-xl inline-block shadow-[0_0_20px_rgba(59,130,246,0.5)]"
          >
            Browse Coins →
          </Link>
        </motion.div>
          ...
          {alerts.map((alert, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`bg-gray-900/60 backdrop-blur-sm border rounded-2xl p-5 transition ${
                  isTriggered
              ...
              >
                ...
                <div className="flex gap-2">
                  <Link
                    ...
                    className="flex-1 bg-gray-800 hover:bg-gray-700 text-center py-2 rounded-lg text-sm font-bold transition"
                  >
                    View Coin
                  </Link>
                  <button
                    onClick={() => deleteAlert(alert.id)}
                    className="flex-1 bg-red-500/20 hover:bg-red-500 text-red-400 hover:text-white py-2 rounded-lg text-sm font-bold transition"
                  >
                    🗑️ Delete
                  </button>
                </div>
